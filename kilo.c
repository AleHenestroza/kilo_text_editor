...
int editorReadKey() {
    ...
    // The Home and End keys can be represneted as a number of ways, depending on the OS.
    // We are handling each case, thus the repetition in the return values in different switches.
    if (c == '\x1b') {
        char seq[3];
